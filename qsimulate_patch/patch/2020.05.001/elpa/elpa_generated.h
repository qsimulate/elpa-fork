 ...
 */
 ...
 void elpa_eigenvectors_dc(elpa_t handle, dcomplex *a, double *ev, dcomplex *q, int *error);
 void elpa_eigenvectors_fc(elpa_t handle, fcomplex *a, float *ev, fcomplex *q, int *error);
 ...
 void elpa_eigenvalues_dc(elpa_t handle, dcomplex *a, double *ev, int *error);
 void elpa_eigenvalues_fc(elpa_t handle, fcomplex *a, float *ev, int *error);
 ...
 int is_already_decomposed, int *error);
 void elpa_generalized_eigenvectors_dc(elpa_t handle, dcomplex *a, dcomplex *b, double *ev, dcomplex *q,
 int is_already_decomposed, int *error);
 void elpa_generalized_eigenvectors_fc(elpa_t handle, fcomplex *a, fcomplex *b, float *ev, fcomplex *q,
 int is_already_decomposed, int *error);
 ...
 int is_already_decomposed, int *error);
 void elpa_generalized_eigenvalues_dc(elpa_t handle, dcomplex *a, dcomplex *b, double *ev,
 int is_already_decomposed, int *error);
 ...
 void elpa_cholesky_dc(elpa_t handle, dcomplex *a, int *error);
 void elpa_cholesky_fc(elpa_t handle, fcomplex *a, int *error);
 void elpa_invert_trm_d(elpa_t handle, double *a, int *error);
 void elpa_invert_trm_f(elpa_t handle, float *a, int *error);
 void elpa_invert_trm_dc(elpa_t handle, dcomplex *a, int *error);
 void elpa_invert_trm_fc(elpa_t handle, fcomplex *a, int *error);
